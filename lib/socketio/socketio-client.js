...
const Methods = {
    ...
    */
    setupSocketIO(socketPort) {
        ...
        instance.defineEvent('reloadview')
            .defaultFn(instance._defFnReloadView.bind(instance));
        instance.defineEvent('reloadprops')
            .defaultFn(instance._defFnReloadProps.bind(instance));
    ...
    _socketPropsChanged(payload) {
        this.emit('reloadprops', payload);
    },
