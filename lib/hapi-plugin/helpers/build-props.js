...
const generate = (request, view, appTitles, config, appConfig, clientRoutes, startupTime) => {
    ...
    if (appConfig.socketServer && appConfig.socketServer.enabled) {
        ...
        props.__appProps['double-reload-response'] = (appConfig.sequentialClientUpdate['update-time'] && appConfig.sequentialClientUpdate['delay-time']);
        props.__appProps['delayed-response'] = !!appConfig.sequentialClientUpdate.delay;
    }
