...
var applyClientRoutes = function() {
    ...
    var getRouteReactView = function(route) {
        ...
        try {
            route.handler({params:{}, query: {}, payload: {}}, fakereply);
            return {
                view: fakereply.view,
...
var invokeAction = function(action, options, request, reply) {
    var prefix = cwd+'/versions/'+packageVersion+'/actions/',
        actionModule, promiseValue;
    try {
        ...
        if (typeof actionModule!=='function') {
            ...
            promiseValue = Promise.resolve(actionModule.call(reply, request, options));
            promiseValue.then(
                function(value) {
...
var initServer = function(server, options) {
    ...
    server.decorate('reply', 'assets', function(filename) {
        var prefix = cwd+'/versions/'+packageVersion+'/assets/',
            reply = this;
