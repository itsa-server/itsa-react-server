            ...
            .then(
                function(affinityView) {
                    ...
                    if (request.headers['x-ajaxtype']==='comp') {
                        fsp.readFile(cwd+'/build/assets/js/'+VIEW_COMPONENT_NRS[affinityView].hash+'.js', 'utf8')
                        .catch(
                            function() {return '';}
                        )
                        .then(
                        ...
                        fsp.readFile(cwd+'/build/assets/css/'+VIEW_COMPONENT_NRS[affinityView].cssfile, 'utf8')
                        .catch(
                            function() {return '';}
                        )
                        .then(
                        ...
                        if (DEFINED_VIEWS[affinityView]===true) {
                            ...
                            if (DEFINED_VIEWS[affinityView]===undefined) {
                                fsp.stat(cwd+'/build/view_components/'+affinityView+'.js').then(
                                    function() {
...
var applyBuildStats = function() {
    return fsp.readJson(cwd+'/build/build-stats.json').then(
        function(data) {
