...
const toView = async (pageTemplate, filename, view, data) => {
    ...
    append += 'render() {\n';
    append += 'return (\n';
    append += '<HtmlPage {...this.props} globalstate={this.props.__appProps.initialGlobalState}>\n';
    append += '<'+extractComponent.bodyComponent+' {...this.props} globalstate={this.props.__appProps.initialGlobalState}/>\n';
    append += '</HtmlPage>\n';
    append += ');\n';
    append += '}\n';
    append += '}\n';
...
const toChunk = async (pageTemplate, filename, mainApp, view, data) => {
    ...
    prepend += 'require(\'itsa-react-globalstate\')\n'; // needs to be available in commons.js
    if (withModulesGeneral) {
        prepend += 'require(\'modules-general\')\n'; // add general modules
    }
    append = '\n';
